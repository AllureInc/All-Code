...
class GeoImportCommand extends AbstractCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        /** @var \Mirasvit\Reports\Model\Config\Source\GeoImportFile $source */
        $source = $this->objectManager->create('Mirasvit\Reports\Model\Config\Source\GeoImportFile');

        /** @var \Mirasvit\Reports\Model\PostcodeFactory $postcodeFactory */
        $postcodeFactory = $this->objectManager->create('Mirasvit\Reports\Model\PostcodeFactory');
