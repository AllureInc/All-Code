...
{
    const XML_PATH_EMAIL_TEMPLATE_FIELD  = 'contact/email/email_template_customer';
    ...
    */
    ...
    public function sendResponseEmail($emailTemplateVariables,$senderInfo,$receiverInfo)
    {
