...
class AutomaticInvoiceGenerationHelper extends \Magento\Framework\App\Helper\AbstractHelper
{
    /**
    ...
    */
    ...
    {
        $writer = new \Zend\Log\Writer\Stream(BP . '/var/log/automatic_invoice_preparation.log');
    ...
    *
    */
    public function getOrderPdfHtmlContent($seller_id = 0, $eligibleOrderIds = [])
    {
    ...
    public function getSellerOrdersData($sellerId){
        try {
                ...
                if(!empty($mageOrders)) {
                    ...
                    $this->_logger->info("## Seller ID: ".$sellerId);
                    $this->_logger->info("## afterDate: ".$afterDate);
