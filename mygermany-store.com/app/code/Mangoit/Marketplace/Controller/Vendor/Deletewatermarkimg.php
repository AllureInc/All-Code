...
/**
 * Mangoit Marketplace Account Deletewatermarkimg Controller.
 */
class Deletewatermarkimg extends Action
{
    /**
        ...
        try {
            ...
            if ($isTranslated) {
                ...
                foreach ($fullCollection as $fullValue) {
                    $fullValue->setProductWatermarkImage('');
                    $fullValue->save();
                }
            } else{
                ...
                if ($autoId != '') {
                    ...
                    $value->setProductWatermarkImage('');
                    $value->save();
                }
            }
