...
class SalesOrderInvoiceSaveAfterObserver extends \Webkul\Marketplace\Observer\SalesOrderInvoiceSaveAfterObserver
{
    /**
     * @var eventManager
     */
    ...
    public function __construct(
        ...
        parent::__construct($eventManager, $customerSession, $checkoutSession, $coreSession, $quoteRepository, $orderRepository, $customerRepository, $productRepository, $marketplaceHelper,$date, $sellerCollection, $ordersFactory, $saleslistFactory, $orderAddressFactory, $countryModel, $mpEmailHelper, $ordersHelper, $productFactory);
    }
