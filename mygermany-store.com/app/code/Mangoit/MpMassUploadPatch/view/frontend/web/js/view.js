        ...
        _create: function () {
            ...
            $(document).ready(function () {
                ...
                $(document).on('click', '#run-profile', function (event) {
                    var id = $("#profile").val();
                    var profile_message = "<div class='wk-warning-content'>"+$.mage.__('Please Select Profile')+"</div>";
                    if (id == "") {
                        alert({
                ...
                $(document).on('change', '#massupload_csv', function (event) {
                    ...
                    if (ext == 'csv') {
                        ...
                        validateFile(ext, 'json', $(this));
                    } else {
                        if(ext == 'xlsx') {
                            validateFile('xls', 'xls', $(this));
                        } else {
                ...
                {
                    var file_message = "<div class='wk-warning-content'>"+$.mage.__('Invalid file type.')+"</div>";
                    if (ext != val) {
                        alert({
                            title: $.mage.__('Warning'),
