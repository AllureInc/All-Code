...
class Product extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('rakuten_pro_id', ['header' => __('Rakuten Pro Id'), 'index' => 'rakuten_pro_id','renderer'  => 'Mangoit\RakutenConnector\Block\Adminhtml\Accounts\Edit\Tab\Renderer\AmazonProduct']);

        $this->addColumn('product_type', ['header' => __('Product Type'), 'index' => 'product_type']);

        $this->addColumn('mage_cat_id', ['header' => __('Magento Category'), 'index' => 'mage_cat_id', 'renderer'  => 'Mangoit\RakutenConnector\Block\Adminhtml\Accounts\Edit\Tab\Renderer\MageCategoryName','filter' => false,'filter_condition_callback' => [$this, '_getCateFilter']]);

        $this->addColumn('error_status', ['header' => __('Error Msg'), 'index' => 'error_status','renderer'  => 'Mangoit\RakutenConnector\Block\Adminhtml\Accounts\Edit\Tab\Renderer\ErrorButton','filter' => false,]);
        
        $this->addColumn('pro_status_at_rkt', ['header' => __('Product Status'), 'index' => 'pro_status_at_rkt']);
    ...
    {
        return $this->getUrl('rakutenconnect/product/gridreset', ['_current' => true]);
    }
}
