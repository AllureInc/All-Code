...
class Order extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection = $this->collectionFactory->getReport('rakutenconnect_order_map_list_data_source')
                                ->addFieldToSelect('entity_id')
                                ->addFieldToSelect('created_at')
                                ->addFieldToSelect('mage_order_id')
                                ->addFieldToSelect('rakuten_order_id')
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('rakuten_order_id', ['header' => __('Rakuten Order Id'), 'index' => 'rakuten_order_id']);
    ...
    {
        return $this->getUrl('rakutenconnect/order/resetgrid', ['_current' => true]);
    }
}
