 ...
 * @license    license
 */
namespace Mangoit\RakutenConnector\Block\ProductExport;

use Magento\Catalog\Api\ProductRepositoryInterface;
use Magento\Catalog\Model\ResourceModel\Product\CollectionFactory;

class ProductToRakuten extends \Magento\Framework\View\Element\Template
{
    /**
    ...
    {
        return $this->getUrl('rakutenconnect/producttorakuten/profiler', ['_secure' => $this->getRequest()->isSecure()]);
    }
    ...
    public function getProductIds()
    {
        ...
        return isset($params['rktn_mass_export'])? $params['rktn_mass_export']:'';
    }
