...
define([
    ...
    $.widget('RakutenConnector.orderimport', {
        _create: function () {
            var self = this;
            ...
            $("body").on("click",'#rakutenconnect-accounts-order-import', function (event) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (response.error_msg==false) {
                            $('#rakutenconnect-import-order-create').removeAttr('disabled');
            ...
            $('#rakutenconnect-import-order-create').on('click',function (e) {
                var width = '1100';
                var height = '400';
                var scroller = 1;
    ...
    return $.RakutenConnector.orderimport;
});