...
namespace Mangoit\Orderdispatch\Block;

/*
 * Mangoit Orderdispatch Order View Block
 */
...
class Printslip extends \Magento\Framework\View\Element\Template
{
    /**
    ...
    {
        parent::_construct();
        $this->pageConfig->getTitle()->set(__('Packing Slip'));
    }

    public function getCustomerId()
    {
        return $_SESSION['customer']['customer_id'];
    }
