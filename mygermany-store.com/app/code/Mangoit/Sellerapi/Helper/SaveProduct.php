 ...
 */
class SaveProduct extends \Magento\Framework\App\Helper\AbstractHelper 
{
    /**
    ...
    public function saveProductData($sellerId, $wholedata)
    {
        ...
        */
        ...
        echo "<br> product type: ".$wholedata['type'];
        ...
        */
        ...
        $catalogProduct = $this->_marketplaceProductBuilder->build($wholedata, $storeId);
        echo "<br> -- 6";
        // print_r(get_class_methods($catalogProduct));
        ...
        if ($catalogProduct->getTypeId() != 'virtual' || $catalogProduct->getTypeId() != 'simple') {
        ...
        try{
            if ($catalogProduct->getTypeId() == 'virtual') {
                echo "<br> HERE - 1";
