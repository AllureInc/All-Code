    ...
    $.widget('mage.WKreportsystem', {
        ...
        _create: function () {
            ...
            $(self.options.topsellingproductajax).on('change', function () {
                ...
                self.topselleingProductAjaxRequest($(this));
            });
        ...
        topselleingProductAjaxRequest:function (element) {
            var self = this;
            var filter = element;
            $.ajax({
        ...
        salesCollectionAjaxRequest: function (data1) {
