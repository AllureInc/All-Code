 ...
 */
namespace Webkul\MpSellerVacation\Block\Plugin\Marketplace\Collection;
...
class ProductList
{
     ...
     * @return html
     */
    public function aroundGetProductPrice(\Webkul\Marketplace\Block\Collection $list, $proceed, $product)
    {
