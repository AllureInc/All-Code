...
class Main extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    public function __construct(
        ...
        \Webkul\MpAmazonConnector\Model\Config\Source\AmazonMarketplace $amzMarketplace,
        array $data = []
    ) {
    ...
    protected function _prepareForm()
    {
        ...
        if (!empty($model->getData())) {
            $savedData['access_key_id'] = isset($savedData['access_key_id']) ? '*****' : '';
            $savedData['secret_key'] = isset($savedData['secret_key']) ? '*****' : '';
        }
