...
class ProductSyncList extends \Magento\Framework\View\Element\Template
{
    ...
    {
        return $this->getUrl('mpamazonconnect/product/import', ['_secure' => $this->getRequest()->isSecure()]);
    }
    ...
    {
        return $this->getUrl('mpamazonconnect/product/generatereport', ['_secure' => $this->getRequest()->isSecure()]);
    }
    /**
     * getProfilerUrl
     * @return string
    ...
    {
        return $this->getUrl('mpamazonconnect/product/profiler', ['_secure' => $this->getRequest()->isSecure()]);
    }
    ...
    {
        return $this->getUrl(
            'mpamazonconnect/producttoamazon/updatestatus',
    ...
    {
        $reportStatus = $this->helper->getSellerAmzCredentials(true)->toArray();
