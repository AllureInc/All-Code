...
class ProductMap extends \Magento\Framework\Model\AbstractModel implements ProductMapInterface //, IdentityInterface
{
     ...
     * CMS page cache tag.
     */
    const CACHE_TAG = 'marketplace_amazon_mapped_product';

    /**
     * @var string
     */
    protected $_cacheTag = 'marketplace_amazon_mapped_product';
     ...
     * @var string
     */
    protected $_eventPrefix = 'marketplace_amazon_mapped_product';
    ...
    {
        $this->_init('Webkul\MpAmazonConnector\Model\ResourceModel\ProductMap');
    }
    /**
     * Get Id.
     *
