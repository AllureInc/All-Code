...
define([
    ...
    "use strict";
    var popup;
    $.widget('mpamazonconnect.productsyncscript', {
        _create: function () {
            var self = this;
            var options = this.options;
            // import amazon product
            $("#amazon-pro-import").on("click", function () {
                var alerttext = '';
                $.ajax({
            ...
            // generate report
            $('#amazon-generate-report').on('click', function () {
                var alerttext = '';
                $.ajax({
                    ...
                    success: function (response) {
                        if (response.error_msg==false) {
                            document.getElementById('amazon-pro-import').removeAttribute('disabled');
    ...
    return $.mpamazonconnect.productsyncscript;
});