...
class Product extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    */
    ...
    /*
    \Webkul\MpAmazonConnector\Logger\Logger
     */
    private $logger;
    ...
    private function _getNewImagePath($imageUrl, $productSku)
    {
        try {
            $path = $this->filesystem->getDirectoryRead(DirectoryList::MEDIA)
                                ->getAbsolutePath().'import/MpAmazonConnector/';
        ...
        try{
            ...
            if ($this->isValidSku($sku)) {
                    ...
                    try {
                        ...
                        // echo "wholeData<pre>";
                        // print_r($proDataReq->getParams());die;
            ...
            $this->logger->info('helper=product function=saveSimpleProduct : '.$e->getMessage());
        }
    }
    ...
    public function getAmzProImage($amzProAsin)
    {
        ...
        try {
            ...
            if (isset($cmptProData['GetMatchingProductResult']['Product'])) {
                ...
                $path = BP.'/pub/media/import/MpAmazonConnector/';
                if (!is_dir($path)) {
    ...
    public function getExistingSkuData($sku)
    {
        try{
            ...
            $this->logger->info('helper=product function=getExistingSkuData : '.$e->getMessage());
        }
    }
