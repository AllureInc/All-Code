        ...
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as $key => $item) {
                if (isset($item['seller_id']) && $item['seller_id'] != 0) {
                    ...
                    $dataSource['data']['items'][$key]['seller_id'] = "<a href='".$this->_urlBuilder->getUrl('customer/index/edit', ['id' => $item['seller_id']])."' target='blank' title='".__('View Customer')."'>".$sellerName.'</a>';
                } else {
