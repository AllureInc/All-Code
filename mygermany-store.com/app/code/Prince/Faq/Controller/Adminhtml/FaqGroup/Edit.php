...
class Edit extends \Prince\Faq\Controller\Adminhtml\FaqGroup
{
    ...
    public function execute()
    {
        ...
        if ($id) {
            ...
            if($id == 1) {
                $this->messageManager->addWarning(__('Category "Other" can not be edited.'));
        ...
        $resultPage->getConfig()->getTitle()->prepend($model->getId() ? $model->getTitle() : __('New FAQ Category'));
        return $resultPage;
    }
}
