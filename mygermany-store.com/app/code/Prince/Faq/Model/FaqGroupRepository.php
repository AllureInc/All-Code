...
class FaqGroupRepository implements FaqGroupRepositoryInterface
{
    ...
    public function save(
        ...
        try {
            ...
            throw new CouldNotSaveException(__(
                'Could not save the FAQ Category: %1',
    ...
    public function getById($faqGroupId)
    {
        ...
        if (!$faqGroup->getId()) {
            throw new NoSuchEntityException(__('FAQ Category with id "%1" does not exist.', $faqGroupId));
        }
        return $faqGroup;
    }
    ...
    public function delete(
        ...
        try {
            ...
            throw new CouldNotDeleteException(__(
                'Could not delete the FAQ Category: %1',
                $exception->getMessage()
            ));
        }
        return true;
