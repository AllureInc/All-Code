...
/**
 * @category  Cnnb
 * @package   Cnnb_NewsLetter
 * @author    Cnnb
 * @copyright Copyright © CNNB All rights reserved.
 *
 * Cnnb_NewsLetter Subscriber.php file for adding subscriber name into email template
 */
namespace Cnnb\NewsLetter\Model;
...
class Subscriber extends \Magento\Newsletter\Model\Subscriber
{
    ...
    public function __construct(
        ...
        \Magento\Newsletter\Model\SubscriptionManagerInterface $subscriptionManager = null
    ) {
        ...
        $this->subscriptionManager = $subscriptionManager ?: ObjectManager::getInstance()
            ->get(\Magento\Newsletter\Model\SubscriptionManagerInterface::class);
    ...
    private function sendEmail(string $emailTemplatePath, string $emailIdentityPath, array $templateVars = []): void
    {
        ...
        /*Code for getting subscriber name*/
        $customerName = '';
        $subscriberCustomerId = $this->getData('customer_id');
        if($subscriberCustomerId) {
        $objectManager = \Magento\Framework\App\ObjectManager::getInstance();
        $customerObj = $objectManager->create('\Magento\Customer\Model\Customer')
            ->load($subscriberCustomerId);
        $customerName = $customerObj->getName();
        }
        $templateVars += ['subscriber' => $this,'customer'=>$customerName];
