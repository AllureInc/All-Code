 ...
 *
 */
namespace Cnnb\OrderEnhance\Controller\Adminhtml\Order\Invoice;
...
class Save extends \Magento\Sales\Controller\Adminhtml\Order\Invoice\Save
{
    ...
    {
        $this->logger->info(' ---- Prepare Shipment ----');
    ...
    {
        $this->logger->info(' ---- Invoice Save Execution ----');
        ...
        try {
            ...
            if (!empty($data['do_shipment'])) {
                if ($this->helper->isModuleEnable()) {
                    $this->helper->addCommentInOrder($orderId, $this->helper->getOrderInvoiceShipmentComment());
                    $this->logger->info(' ---- You created the invoice and shipment. ----');
                    # code...
                }
                $this->messageManager->addSuccessMessage(__('You created the invoice and shipment.'));
            } else {
                if ($this->helper->isModuleEnable()) {
                    $this->logger->info(' ---- Now Incoice will be created  ----');
                    $this->helper->addCommentInOrder($orderId, $this->helper->getOrderInvoiceComment());
                    $this->logger->info(' ---- The invoice has been created. ----');
                    # code...
                }
