 ...
 *
 */
namespace Cnnb\OrderEnhance\Controller\Adminhtml\Order\Shipment;
...
class Save extends \Magento\Shipping\Controller\Adminhtml\Order\Shipment\Save
{
    ...
    {
        $this->logger->info(' ---- Shipment Execution ----');
        ...
        try {
            ...
            if ($this->helper->isModuleEnable()) {
                ...
                $this->helper->addCommentInOrder($orderId, $this->helper->getOrderShipmentComment());
                $this->logger->info(' ---- You created the shipment. Order ID: '.$orderId.' ----');
                $this->logger->info(' ---- Shipment Execution Ends ----');
            }
