...
use Kerastase\AdminActivity\Model\Activity\SystemConfig;

/**
 * Class ActivityRepository
 * @package Kerastase\AdminActivity\Model
 */
class ActivityRepository implements \Kerastase\AdminActivity\Api\ActivityRepositoryInterface
{
    /**
     * @var string
     */
    ...
    public function __construct(
        ...
        \Kerastase\AdminActivity\Model\ResourceModel\Activity\CollectionFactory $collectionFactory,
        \Kerastase\AdminActivity\Model\ActivityLogDetailFactory $activityLogDetailFactory,
        \Kerastase\AdminActivity\Model\ActivityLogFactory $activityLogFactory,
        \Kerastase\AdminActivity\Model\ResourceModel\ActivityLog\CollectionFactory $LogCollectionFactory,
        \Kerastase\AdminActivity\Model\Activity\SystemConfig $systemConfig,
        \Kerastase\AdminActivity\Model\Activity\ThemeConfig $themeConfig,
    ...
    public function revertActivity($activity)
    {
        ...
        if (\Kerastase\AdminActivity\Helper\Data::isWildCardModel($detailModel->getModelClass())) {
