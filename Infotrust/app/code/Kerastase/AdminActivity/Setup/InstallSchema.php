 ...
 */
namespace Kerastase\AdminActivity\Setup;
...
/**
 * Class InstallSchema
 * @package Kerastase\AdminActivity\Setup
 */
class InstallSchema implements InstallSchemaInterface
{
    ...
    public function install(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
         ...
         */
        $table = $installer->getConnection()->newTable(
            $installer->getTable('admin_activity_log')
        )->addColumn(
            'entity_id',
            \Magento\Framework\DB\Ddl\Table::TYPE_INTEGER,
            10,
            ...
            'Entity id of admin_activity table'
        )->addColumn(
            'field_name',
            \Magento\Framework\DB\Ddl\Table::TYPE_TEXT,
            32,
            ...
            $installer->getIdxName('admin_activity', ['entity_id']),
            ['activity_id']
        )->addForeignKey(
            $installer->getFkName(
                'admin_activity_log',
        ...
        /**
         * Create table 'admin_activity_detail'
         */
        $table = $installer->getConnection()->newTable(
            $installer->getTable('admin_activity_detail')
        )->addColumn(
            'entity_id',
            \Magento\Framework\DB\Ddl\Table::TYPE_INTEGER,
            10,
