...
return [
    'modules' => [
        ...
        'Algolia_AlgoliaSearchInventory' => 0,
        'Amazon_Core' => 1,
        'Amazon_Login' => 1,
        'Amazon_Payment' => 1,
        'MGS_AjaxCart' => 1,
        'Cnnb_CheckoutTranslation' => 1,
        'Cnnb_GoogleLocalizedSite' => 1,
        'Cnnb_GoogleReviewSnippet' => 1,
        'Cnnb_Gtm' => 0,
        'Cnnb_GtmWeb' => 0,
        'Cnnb_NewsLetter' => 1,
        'Cnnb_OrderEnhance' => 1,
        'Cnnb_OrderRestore' => 1,
        'Cnnb_OwlCarouselFix' => 1,
        'Cnnb_ProductCollection' => 1,
        'Cnnb_WhatsappApi' => 1,
        'Dotdigitalgroup_Email' => 1,
        'Dotdigitalgroup_Chat' => 1,
        'Dotdigitalgroup_Enterprise' => 1,
        'EthanYehuda_CronjobManager' => 1,
        'Kerastase_AdminActivity' => 1,
        'Kerastase_Aramex' => 1,
        'Kerastase_CODFee' => 1,
        'Kerastase_Core' => 1,
        'Kerastase_Customers' => 1,
        'Kerastase_GiftRule' => 1,
        'Klarna_Core' => 1,
        ...
        'Cnnb_AlgoliaFix' => 0,
        'Mageplaza_Core' => 0,
        'Mageplaza_CronSchedule' => 0,
        'Onestepcheckout_Iosc' => 1,
        'PayPal_Braintree' => 0,
        'PayPal_BraintreeGraphQl' => 0,
        'Payfort_Fort' => 1,
        'Sparsh_SalesEmailAttachments' => 0,
